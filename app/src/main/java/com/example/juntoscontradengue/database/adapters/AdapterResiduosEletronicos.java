...
public class AdapterResiduosEletronicos extends RecyclerView.Adapter<AdapterResiduosEletronicos.ViewHolder> {

    private final List<ClassDescarteConsciente> descarteConscienteClass;
    private final ClickResiduosEletronicos clickResiduosEletronicos;

    public AdapterResiduosEletronicos(Context context, List<ClassDescarteConsciente> descarteConscienteClass, ClickResiduosEletronicos clickResiduosEletronicos) {
        this.descarteConscienteClass = descarteConscienteClass;
        this.clickResiduosEletronicos = clickResiduosEletronicos;
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.cardView.setOnClickListener(view -> {
            if (clickResiduosEletronicos != null) {
                clickResiduosEletronicos.click_DescarteEletronicos(descarteConcienteClass1);
            }
        });
    }
    ...
    public interface ClickResiduosEletronicos {
        void click_DescarteEletronicos(ClassDescarteConsciente descarteEletronicosClass);
    }
