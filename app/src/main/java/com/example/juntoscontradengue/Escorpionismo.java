...
public class Escorpionismo extends AppCompatActivity {
    ...
    private static final String TAG = "ESCORPIAO";
    private static final long TIMEOUT_CARREGAMENTO_MS = 5000;
    private static final String ARQUIVO_CACHE_HTML = "escorpiao_html_cache.html";
    private static final Pattern PADRAO_IMG =
            Pattern.compile("<img[^>]+src\\s*=\\s*[\"'](https?://[^\"']+)[\"']", Pattern.CASE_INSENSITIVE);

    private ActivityEscorpionismoBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityEscorpionismoBinding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());

        webView = binding.webViewEscorpiao;
        progressBar = binding.progressEscorpiao;

        Toolbar toolbar = binding.toolbarEscorpiao;
    ...
    private void carregarDoFirebase() {
        htmlListener = new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                boolean online = NetworkUtils.isNetworkAvailable(Escorpionismo.this);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                if (NetworkUtils.isNetworkAvailable(Escorpionismo.this)) {
                    mostrarAviso();
                } else {
                    irParaSemInternet();
                }
    ...
    private void mostrarAviso() {
        ...
        String aviso = "<html><head><meta name='viewport' content='width=device-width, initial-scale=1'></head>"
                ...
                + "</body></html>";
        webView.loadDataWithBaseURL(null, aviso, "text/html", "UTF-8", null);
    }
    ...
    private void atualizarBannerOffline() {
        ...
        binding.txtAvisoOfflineEscorpionismo.setVisibility(conectado ? View.GONE : View.VISIBLE);
    }
    ...
    private void irParaSemInternet() {
        ...
        Intent intent = new Intent(Escorpionismo.this, SemInternetActivity.class);
