...
public class Dengue extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        com.example.juntoscontradengue.databinding.ActivityDengueBinding binding = ActivityDengueBinding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());

        webView = binding.webViewDengue;
    ...
    private void carregarAssets() {
        webView.loadUrl("file:///android_asset/dengue/index_aedes_aegypti.html");
    }
}